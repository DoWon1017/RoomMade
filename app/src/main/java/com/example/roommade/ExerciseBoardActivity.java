...
public class ExerciseBoardActivity extends AppCompatActivity {
    ...
    private void fetchPosts(String currentUserId) {
        ...
        registration = db.collection("exercise_posts")
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(QuerySnapshot snapshot, FirebaseFirestoreException e) {
                        ...
                        for (QueryDocumentSnapshot doc : snapshot) {
                            ...
                            // 체크박스 추가
                            CheckBox checkBox = new CheckBox(ExerciseBoardActivity.this);
            ...
            for (String postId : selectedPostIds) {
                db.collection("exercise_posts").document(postId)
                        ...
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(ExerciseBoardActivity.this, "게시글을 삭제하였습니다.", Toast.LENGTH_SHORT).show();
                        })
                        .addOnFailureListener(e -> {
                            Toast.makeText(ExerciseBoardActivity.this, "게시글 삭제를 실패하였습니다.", Toast.LENGTH_SHORT).show();
                        });
            }
        } else {
