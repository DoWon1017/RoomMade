...
public class ExerciseBoardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_myexercise); // fragment_myexercise.xml 파일 설정
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 바로 이전 페이지로 이동
                Intent intent = new Intent(ExerciseBoardActivity.this, ActivityC.class); // ActivityC는 이전 페이지의 액티비티 클래스
