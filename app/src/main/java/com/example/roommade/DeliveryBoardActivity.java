...
public class DeliveryBoardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_mydelivery); // fragment_mydelivery.xml 파일 설정
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 바로 이전 페이지로 이동
                Intent intent = new Intent(DeliveryBoardActivity.this, ActivityC.class); // ActivityC는 이전 페이지의 액티비티 클래스
    ...
    private void fetchPosts() {
        registration = db.collection("delivery_posts")
